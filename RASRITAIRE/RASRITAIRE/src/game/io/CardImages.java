...
public final class CardImages {
	...
	static {
		try {
			...
			CardImages.images = new BufferedImage[53]; //ประกาศเพื่อเก็บภาพของไพ่ที่ถูกตัดออกมาแล้ว
			...
			CardImages.images[52] = CardImages.back; //เก็บข้างหลังของไฟ่
		} catch (final IOException | IllegalArgumentException ex) {//เมื่อไม่เจอไฟล์ card
			ex.printStackTrace();
